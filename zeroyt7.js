...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Dukung Koo'store',
			error: {
...
var ase = new Date();
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = zeroyt7.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "LIST MENU","footerText": "Dukung Koo'store\nMade With Eko Kurniawan","listType": "SINGLE_SELECT","sections": list}}, {})
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `Dukung Koo'store`, 
                            orderTitle: `Dukung Koo'store`,
...
*┗━━━━━━━ •*`
        ...
        sendButton(from, teks, '©Created : Koo'store', but, mek)
break
case 'sewat':
...
costum(buffer, sticker, Verived, `Jangan Lupa Dukung Koo'store`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Dukung Koo'store`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Dukung Koo'store' })
fs.unlinkSync(ran)
})
break
...
├ Sc Full Fitur = 
├─────────────────────
├ Creator Base = Koo'store
├ Creator Sc = Koo'store
└─────────────────────`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case "on":
...
//━━━━━━━━━━━━━━━[ FITUR MAKER ]━━━━━━━━━━━━━━━━━//
        ...
        break
        case "sertiff1":
        if (args.length < 1) return reply(`Teksnya Mana Tod ?\nContoh: ${prefix + command}Koo'store`)
        pll = body.slice(10);
        reply("Loading.....");
        ...
        case "googlem":
				...
				if (args.length < 1) return reply(`Teksnya Mana Tod ?\nContoh: ${prefix + command}Koo'store | ganteng | banget`)
				reply(mess.wait)
kontol = body.slice(8)
...
//━━━━━━━━━━━━━━━[ FITUR RANDOM IMAGE ]━━━━━━━━━━━━━━━━━//
      ...
      case "aeshtetic":
      case "wallpaperanime":
      sendButton(from, `Random Image By Koo'store`, `press the button below`, [
          {
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Dukung Koo'store'})
})
break
default:
if (isOwner) {
